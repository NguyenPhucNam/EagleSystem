...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.router.events
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function (e) { return e instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterEvent"]; }))
            .subscribe(function (e) {
            if (e instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["NavigationStart"]) {
                if (_this.routingLists.includes(e.url)) {
                    _this.hasNav = true;
                }
                else {
                    _this.hasNav = false;
...
var StorageService = /** @class */ (function () {
    ...
    StorageService.prototype.deleteFile = function (name) {
...
var UploadService = /** @class */ (function () {
    ...
    UploadService.prototype.upload = function (files) {
        ...
        var options = { reportProgress: true, observe: 'events' };
        files.forEach(function (file) {
            ...
            var req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpRequest"]('POST', src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].api + "/uploads", formData, options);
